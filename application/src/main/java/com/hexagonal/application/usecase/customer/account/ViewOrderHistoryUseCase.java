...
import com.hexagonal.application.port.in.customer.account.ViewOrderHistoryInputPort;
...
public class ViewOrderHistoryUseCase implements ViewOrderHistoryInputPort {
