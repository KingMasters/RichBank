...
public class UpdateProductQuantityInCartUseCaseHandler implements UpdateProductQuantityInCartUseCase {
    private final CartRepositoryPort cartRepository;
    private final ProductRepositoryPort productRepository;

    public UpdateProductQuantityInCartUseCaseHandler(CartRepositoryPort cartRepository, ProductRepositoryPort productRepository) {
