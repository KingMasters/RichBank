...
public class PasswordChangeUseCaseHandler implements ChangePasswordUseCase {
    private final CustomerRepositoryPort customerRepository;
    private static final int PASSWORD_HISTORY_CHECK = 6;

    public PasswordChangeUseCaseHandler(CustomerRepositoryPort customerRepository) {
