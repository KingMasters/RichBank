...
import com.hexagonal.application.usecases.admin.product.CreateProductUseCase;
...
public class CreateProductInputPort implements CreateProductUseCase {
    ...
    public CreateProductInputPort(ProductRepositoryOutputPort productRepository) {
