...
import com.hexagonal.application.usecases.customer.account.ChangePasswordUseCase;
...
public class PasswordChangeInputPort implements ChangePasswordUseCase {
    private final CustomerRepositoryOutputPort customerRepository;
    private static final int PASSWORD_HISTORY_CHECK = 6;

    public PasswordChangeInputPort(CustomerRepositoryOutputPort customerRepository) {
