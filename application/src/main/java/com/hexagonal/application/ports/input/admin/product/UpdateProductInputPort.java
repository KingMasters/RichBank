...
import com.hexagonal.application.usecases.admin.product.UpdateProductUseCase;
...
public class UpdateProductInputPort implements UpdateProductUseCase {
    ...
    public UpdateProductInputPort(ProductRepositoryOutputPort productRepository) {
