...
import com.hexagonal.application.usecases.customer.checkout.EnterShippingInformationUseCase;
...
public class EnterShippingInformationInputPort implements EnterShippingInformationUseCase {
    private final CartRepositoryOutputPort cartRepository;
    private final CustomerRepositoryOutputPort customerRepository;

    public EnterShippingInformationInputPort(CartRepositoryOutputPort cartRepository, CustomerRepositoryOutputPort customerRepository) {
