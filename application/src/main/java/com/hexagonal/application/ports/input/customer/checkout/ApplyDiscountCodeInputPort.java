...
import com.hexagonal.application.usecases.customer.checkout.ApplyDiscountCodeUseCase;
import com.hexagonal.entity.Cart;
import com.hexagonal.exception.EntityNotFoundException;
import com.hexagonal.vo.ID;

public class ApplyDiscountCodeInputPort implements ApplyDiscountCodeUseCase {
    private final CartRepositoryOutputPort cartRepository;

    public ApplyDiscountCodeInputPort(CartRepositoryOutputPort cartRepository) {
