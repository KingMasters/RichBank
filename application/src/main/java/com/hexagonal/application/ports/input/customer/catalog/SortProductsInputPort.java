...
import com.hexagonal.application.usecases.customer.catalog.SortProductsUseCase;
...
public class SortProductsInputPort implements SortProductsUseCase {
    public SortProductsInputPort() {
    }
