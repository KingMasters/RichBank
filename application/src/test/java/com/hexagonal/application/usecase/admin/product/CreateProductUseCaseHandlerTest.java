...
class CreateProductUseCaseHandlerTest {
    ...
    void shouldCreateProductSuccessfully() {
        ...
        // When
        Product result = createProductUseCaseHandler.execute(command);
    ...
    void shouldThrowExceptionWhenSkuAlreadyExists() {
        ...
        // Then
        assertThatThrownBy(() -> createProductUseCaseHandler.execute(command))
    ...
    void shouldCreateProductWithCategories() {
        ...
        // When
        Product result = createProductUseCaseHandler.execute(commandWithCategories);
