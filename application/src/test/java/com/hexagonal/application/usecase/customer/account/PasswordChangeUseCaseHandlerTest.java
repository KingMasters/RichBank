...
class PasswordChangeUseCaseHandlerTest {

    @Mock
    private CustomerRepositoryPort customerRepository;

    @InjectMocks
    private PasswordChangeUseCaseHandler passwordChangeUseCaseHandler;
    ...
    void shouldChangePasswordSuccessfully() throws Exception {
        ...
        // When
        passwordChangeUseCaseHandler.execute(command);
    ...
    void shouldThrowWhenNewPasswordInHistory() throws Exception {
        ...
        // Then
        assertThatThrownBy(() -> passwordChangeUseCaseHandler.execute(command))
    ...
    void shouldThrowWhenCommandIsNull() {
        assertThatThrownBy(() -> passwordChangeUseCaseHandler.execute(null))
            .isInstanceOf(IllegalArgumentException.class)
