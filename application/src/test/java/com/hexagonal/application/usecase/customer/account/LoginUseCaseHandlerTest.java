...
class LoginUseCaseHandlerTest {
    ...
    void shouldLoginSuccessfullyWithValidCredentials() {
        ...
        // When
        Customer result = loginUseCaseHandler.execute(command);
    ...
    void shouldThrowExceptionWhenCustomerNotFound() {
        ...
        // Then
        assertThatThrownBy(() -> loginUseCaseHandler.execute(command))
    ...
    void shouldThrowExceptionWhenCommandIsNull() {
        // Then
        assertThatThrownBy(() -> loginUseCaseHandler.execute(null))
