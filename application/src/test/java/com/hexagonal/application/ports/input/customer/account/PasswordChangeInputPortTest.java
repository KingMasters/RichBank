...
class PasswordChangeInputPortTest {

    @Mock
    private CustomerRepositoryOutputPort customerRepository;

    @InjectMocks
    private PasswordChangeInputPort passwordChangeInputPort;
    ...
    void shouldThrowWhenNewPasswordInHistory() throws Exception {
        ...
        // Then
        assertThatThrownBy(() -> passwordChangeInputPort.execute(command))
    ...
    void shouldThrowWhenCommandIsNull() {
        assertThatThrownBy(() -> passwordChangeInputPort.execute(null))
            .isInstanceOf(IllegalArgumentException.class)
